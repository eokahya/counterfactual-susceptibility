...
on CUDA, and the source is released before the pinned transcoders are loaded.
This avoids holding either a second full model on the 12.7-GiB Colab host or the
