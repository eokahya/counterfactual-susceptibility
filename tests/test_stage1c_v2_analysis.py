...
from cfsus.stage1c_v2.analysis import aggregate_analyses, analyze_pair, classify_outcome


def _pair(group: str = "primary", *, crossing: bool = True) -> dict[str, object]:
    baseline = {
...
def test_v2_analysis_classification_and_empty_terminal() -> None:
    pair = _pair()
    result = analyze_pair(
        pair,
        pair["points"],
...
def test_v2_analysis_requires_exact_full_ablation() -> None:
    pair = _pair()
