"""Frozen v3 pair analyses and scientific outcome classification."""
...
def analyze_pair(
    ...
    return {
        ...
        "group": group,
        "exact_pair_key": pair.get("exact_pair_key"),
        "endpoint_overlap_category": pair.get("endpoint_overlap_category"),
...
def classify_outcome(pair_analyses: list[dict[str, Any]]) -> ScientificOutcome:
    """Apply the frozen v3 outcome precedence after a valid canonical runtime."""
