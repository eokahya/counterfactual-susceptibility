"""Detached worker-result construction for the Stage 1C-v3 protocol.
...
def build_detached_worker_result(
    ...
    **fields: Any,
    ...
    instrumented = fields.get("instrumented_source_suppression_api_calls")
    if instrumented is not None and instrumented != calls:
        raise SerializationError(
            "instrumented API-call count differs from serialized point count"
        )
