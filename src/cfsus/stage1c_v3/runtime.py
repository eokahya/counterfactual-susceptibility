"""Stage 1C-v3 baseline backend built on accepted Stage 1B primitives."""
...
from cfsus.stage1c_v3.vjp import TargetBatchVJPContext
from cfsus.types import FeatureActivity, FeatureRef, MeasuredFeatureState


class Stage1CVersion3PredictionBackend(NNSightPLTMeasurementBackend):
...
Stage1CPredictionBackend = Stage1CVersion3PredictionBackend

__all__ = ["Stage1CPredictionBackend", "Stage1CVersion3PredictionBackend"]
