"""Frozen source-suppression schedule and BF16 application mapping."""
...
def plan_applied_values(
    ...
    """Compute high-precision desired values, cast once, and deduplicate BF16."""
...
def bisection_requested_alpha(lower_realized: float, upper_realized: float) -> float:
    """Return the deterministic midpoint of a strict realized-suppression bracket."""
