"""Stage 1C baseline backend built strictly on accepted Stage 1B primitives."""
...
from cfsus.backends.nnsight_plt import (
    FEATURE_WIDTH,
...
class Stage1CPredictionBackend(NNSightPLTMeasurementBackend):
    """Add active-source collection and many-source response tiles."""
    ...
    def collect_active_sources(
        ...
        *,
        ...
        """Collect all exact loaded active states with bounded per-chunk tensors."""
    ...
    def response_tile(
        ...
        *,
        ...
        """Compute one bounded target-by-source tile and immediately scalarize it."""
...
__all__ = ["Stage1CPredictionBackend"]
