"""Held-out v2 single-source intervention adapter with dynamic token length."""
...
from cfsus.stage1c_v2.intervention import AppliedValuePlan, applied_plan_record
...
class Stage1CVersion2InterventionBackend:
    ...
    def __init__(
        ...
        if (
            ...
            raise ScientificInputError(
                "held-out prompt must have a BOS and content token"
            )
...
Stage1CInterventionBackend = Stage1CVersion2InterventionBackend

__all__ = ["Stage1CInterventionBackend", "Stage1CVersion2InterventionBackend"]
