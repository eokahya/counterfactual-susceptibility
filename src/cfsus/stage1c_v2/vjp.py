"""Bounded graph-independent target-batch VJP contractions for v2."""
...
class TargetBatchVJPContext:
    """Evaluate fresh target batches against a canonical source pool."""
    ...
    def cache(self, model: Any, tracer: Any, barrier: Any = None) -> None:
        """Cache the same residual/feature-output points as Stage 1B."""
    ...
    def compute(
        ...
        *,
        ...
        """Return one transient target-by-source MPS/BF16 response tile."""
